...
In RLHF (see [RLHF and DPO](/reference/rlhf-and-dpo/)):
...
- [Policy gradient](/reference/policy-gradient/). Foundational algorithm.
- [RLHF and DPO](/reference/rlhf-and-dpo/). LLM-alignment context.
