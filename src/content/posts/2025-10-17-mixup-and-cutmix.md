...
<figure class="learning-figure plot-panel" aria-labelledby="mixup-cutmix-visual-title">
	...
	<svg viewBox="0 0 360 550" role="img" aria-labelledby="mixup-cutmix-svg-title mixup-cutmix-svg-desc">
		...
		<text class="viz-callout" x="20" y="130">MIXUP · λ = 0.75</text><text class="viz-edge-label" x="340" y="130" text-anchor="end">blend every location</text>
		...
		<text class="viz-callout" x="20" y="286">CUTMIX · REALIZED λ = 12/16 = 0.75</text><text class="viz-edge-label" x="340" y="304" text-anchor="end">replace a countable region</text>
