...
<figure class="learning-figure plot-panel" aria-labelledby="multi-head-visual-title">
	...
	<div class="visual-scroll">
		<svg viewBox="0 0 360 510" role="img" aria-labelledby="multi-head-svg-title multi-head-svg-desc">
			...
			<text class="viz-axis-label" x="16" y="178">3 · h PARALLEL HEADS; dₕ = d/h</text>
			...
			<text class="viz-axis-label" x="16" y="354">4 · CONCATENATE FEATURE SLICES</text>
			...
			<text class="viz-axis-label" x="16" y="438">5 · MIX HEADS WITH OUTPUT PROJECTION</text>
