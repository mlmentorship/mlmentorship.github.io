...
<figure class="learning-figure" aria-labelledby="mutual-information-budget-title" aria-describedby="mutual-information-budget-description"><p class="visual-kicker">Worked uncertainty budget</p><p class="visual-title" id="mutual-information-budget-title">Observing Y removes the shared part of X's uncertainty.</p><p id="mutual-information-budget-description">One bit splits into 0.531 bits removed by Y and 0.469 bits still uncertain.</p><svg class="information-budget-visual" viewBox="0 0 900 420" role="img" aria-labelledby="mutual-information-svg-title mutual-information-svg-description" width="900" height="420"><title id="mutual-information-svg-title">Mutual information is the uncertainty removed by observing another variable</title><desc id="mutual-information-svg-description">A one-bit horizontal bar for H of X is split into zero point five three one bits removed by Y and zero point four six nine bits still uncertain after Y. A second inset shows a two by two joint table where diagonal match probabilities are zero point four five and off-diagonal flip probabilities are zero point zero five, with both marginals equal to one half.</desc><text x="46" y="45" fill="var(--c-text)" font-family="Lato, sans-serif" font-size="20" font-weight="700">One bit of X before observing Y</text><text x="46" y="70" fill="var(--c-muted)" font-family="Lato, sans-serif" font-size="13">binary noisy channel with flip probability 0.1</text><rect x="60" y="112" width="520" height="72" rx="8" fill="var(--viz-neutral-bg)" stroke="var(--c-rule)" /><rect x="60" y="112" width="276" height="72" rx="8" fill="var(--viz-focus-bg)" stroke="var(--viz-focus-stroke)" stroke-width="2" /><rect x="336" y="112" width="244" height="72" rx="8" fill="var(--viz-output-bg)" stroke="var(--viz-output-stroke)" stroke-width="2" /><text x="198" y="145" text-anchor="middle" fill="var(--c-text)" font-family="Lato, sans-serif" font-size="18" font-weight="700">0.531 bits</text><text x="198" y="166" text-anchor="middle" fill="var(--c-text-soft)" font-family="Lato, sans-serif" font-size="13">removed by observing Y</text><text x="458" y="145" text-anchor="middle" fill="var(--c-text)" font-family="Lato, sans-serif" font-size="18" font-weight="700">0.469 bits</text><text x="458" y="166" text-anchor="middle" fill="var(--c-text-soft)" font-family="Lato, sans-serif" font-size="13">still uncertain: H(X|Y)</text><text x="60" y="210" fill="var(--viz-focus-stroke)" font-family="Lato, sans-serif" font-size="14" font-weight="700">I(X;Y) = H(X) - H(X|Y) = 1.000 - 0.469</text><circle cx="230" cy="295" r="74" fill="var(--viz-input-bg)" fill-opacity="0.78" stroke="var(--viz-input-stroke)" stroke-width="2" /><circle cx="318" cy="295" r="74" fill="var(--viz-output-bg)" fill-opacity="0.78" stroke="var(--viz-output-stroke)" stroke-width="2" /><path d="M274 236 A74 74 0 0 1 274 354 A74 74 0 0 1 274 236" fill="var(--viz-focus-bg)" stroke="var(--viz-focus-stroke)" stroke-width="2" /><text x="195" y="292" text-anchor="middle" fill="var(--c-text)" font-family="Lato, sans-serif" font-size="14" font-weight="700">H(X)</text><text x="351" y="292" text-anchor="middle" fill="var(--c-text)" font-family="Lato, sans-serif" font-size="14" font-weight="700">H(Y)</text><text x="274" y="292" text-anchor="middle" fill="var(--c-text)" font-family="Lato, sans-serif" font-size="14" font-weight="700">shared</text><text x="274" y="310" text-anchor="middle" fill="var(--c-text)" font-family="Lato, sans-serif" font-size="13">0.531</text><text x="86" y="386" fill="var(--c-muted)" font-family="Lato, sans-serif" font-size="12">Overlap is a memory aid: shared information, not a causal direction.</text><text x="640" y="45" fill="var(--c-text)" font-family="Lato, sans-serif" font-size="20" font-weight="700">Fair marginals can still depend</text><text x="640" y="70" fill="var(--c-muted)" font-family="Lato, sans-serif" font-size="13">probability mass concentrates on agreement</text><rect x="635" y="108" width="86" height="58" rx="5" fill="var(--viz-focus-bg)" stroke="var(--viz-focus-stroke)" stroke-width="2" /><rect x="725" y="108" width="86" height="58" rx="5" fill="var(--viz-neutral-bg)" stroke="var(--c-rule)" /><rect x="635" y="170" width="86" height="58" rx="5" fill="var(--viz-neutral-bg)" stroke="var(--c-rule)" /><rect x="725" y="170" width="86" height="58" rx="5" fill="var(--viz-focus-bg)" stroke="var(--viz-focus-stroke)" stroke-width="2" /><text x="678" y="141" text-anchor="middle" fill="var(--c-text)" font-family="Lato, sans-serif" font-size="17" font-weight="700">0.45</text><text x="768" y="141" text-anchor="middle" fill="var(--c-text-soft)" font-family="Lato, sans-serif" font-size="17" font-weight="700">0.05</text><text x="678" y="203" text-anchor="middle" fill="var(--c-text-soft)" font-family="Lato, sans-serif" font-size="17" font-weight="700">0.05</text><text x="768" y="203" text-anchor="middle" fill="var(--c-text)" font-family="Lato, sans-serif" font-size="17" font-weight="700">0.45</text><text x="678" y="95" text-anchor="middle" fill="var(--c-muted)" font-family="Lato, sans-serif" font-size="12">Y=0</text><text x="768" y="95" text-anchor="middle" fill="var(--c-muted)" font-family="Lato, sans-serif" font-size="12">Y=1</text><text x="610" y="142" text-anchor="end" fill="var(--c-muted)" font-family="Lato, sans-serif" font-size="12">X=0</text><text x="610" y="204" text-anchor="end" fill="var(--c-muted)" font-family="Lato, sans-serif" font-size="12">X=1</text><text x="826" y="142" fill="var(--c-text-soft)" font-family="Lato, sans-serif" font-size="13">row = 0.50</text><text x="826" y="204" fill="var(--c-text-soft)" font-family="Lato, sans-serif" font-size="13">row = 0.50</text><text x="651" y="255" fill="var(--c-text-soft)" font-family="Lato, sans-serif" font-size="13">column totals also 0.50 / 0.50</text><path d="M620 292 H850" stroke="var(--c-rule)" stroke-width="1.5" /><text x="640" y="328" fill="var(--viz-focus-stroke)" font-family="Lato, sans-serif" font-size="14" font-weight="700">Y is fair, but usually equal to X</text><text x="640" y="350" fill="var(--c-muted)" font-family="Lato, sans-serif" font-size="12">That diagonal concentration is the shared information.</text></svg><figcaption><strong>Read it this way:</strong> the full bar is the one bit you do not know about X. Observing Y cuts away 0.531 bits because the channel usually copies X; the 0.469-bit segment is the remaining flip uncertainty. The inset explains why this can happen even though X and Y each still look fair on their own.</figcaption></figure>
