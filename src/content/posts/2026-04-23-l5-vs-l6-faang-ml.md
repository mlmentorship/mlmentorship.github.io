...
flowchart TB
	...
	Queue -. "replace approvals with boundaries" .-> Coherence["DELEGATED COHERENCE"]
	...
	Decisions -. "cross-boundary change" .-> Review{"Interface conflict?<br/>joint review"}
	Evidence["External or outcome evidence"] -. "revisit shared constraint" .-> Doctrine
	...
	class Bottleneck,Requests,Approver,Queue,Coherence,Doctrine,Owners,Decisions,Review,Evidence viz-compact
```
